# Atmosic Matter Lighting Example Application

The Atmosic Lighting Example demonstrates how to remotely control a white
...
-   Standalone, using a single EVK that runs the lighting application.
...
**LED 1 - Red** simulates the light bulb and shows the state of the lighting.
...
**LED 2 - Yellow** shows the overall state of the device and its connectivity. The
...
1.  Navigate to the example's directory:
        ...
        $ cd examples/lighting-app/atmosic
